...
-- DropForeignKey
ALTER TABLE "VenueStaffRole" DROP CONSTRAINT "VenueStaffRole_userId_fkey";

-- AlterTable
ALTER TABLE "BandMember" ALTER COLUMN "userId" SET DATA TYPE TEXT;
...
-- AlterTable
ALTER TABLE "VenueStaffRole" ALTER COLUMN "userId" SET DATA TYPE TEXT;
